...
{
    public interface IDosOrmRepository<T> : Core.IRepository<T> where T : Entity
    {
        #region 查询
        ...
        /// 通用查询
        /// </summary>
        List<T> Query(Where<T> where, Expression<Func<T, object>> orderBy = null, string ascOrDesc = "asc", 
            int? top = null, int? pageSize = null, int? pageIndex = null);
        /// <summary>
        /// 通用查询
        /// </summary>
        List<T> Query(Where<T> where, OrderByClip orderBy = null, string ascOrDesc = "asc", 
            int? top = null, int? pageSize = null, int? pageIndex = null);
